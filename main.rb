...
require "./country.rb"
require "./loan_status.rb"
require "./security_council.rb"
require "./war_status.rb"
class Main
  ...
  def get_country_by_id(id)
    d = @countries.find {|c| c.country_id == id }
    return d
  end
end
...
while flag>0
  ...
  when 3
      ...
      if country != nil
        app.country_loan_check(country.gdp,country.state_of_country)
      else
  ...
  when 5
      ...
      country = app.get_country_by_id(id)
      if country != nil 
        app.war_winning_chances(country)
      else
        puts "Country is not present"  
      end
  when 6
